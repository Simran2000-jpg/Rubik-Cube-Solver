...
def color_detect(h,s,v):
    # print(h,s,v)
    if h>0 and h <=9  and s>50 and s<255 and v>50 and v<255:
        return 'red'
    elif h>=10 and h<=20 and s>=50 and s<=255 and v>=70 and v<255:
        return 'orange'
    elif h >=25 and h<=35 and s>=50 and s<=255 and v>=70 and v<255:
        return 'yellow'
    elif h>=36 and h<90  and s>=50 and s<=255 and v>=70 and v<255:
        return 'green'
    elif h>90 and h <= 129 and s>=50 and s<255 and v>=70 and v<255:
        return 'blue'
